 ...
 *
 */
package com.sap.social.addons.excelsior.hmc;
...
/**
 * Provides necessary meta information about the excelsiorjsaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.5.1.0
 */
public class ExcelsiorjsaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(ExcelsiorjsaddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.sap.social.addons.excelsior.hmc.locales";
