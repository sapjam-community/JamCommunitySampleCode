 ...
 *
 */
package com.sap.social.addons.excelsior.jalo;
...
/**
 * This is the extension manager of the Excelsiorjsaddon extension.
 */
public class ExcelsiorjsaddonManager extends GeneratedExcelsiorjsaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ExcelsiorjsaddonManager.class.getName());
	 ...
	 */
	public static ExcelsiorjsaddonManager getInstance()
	{
		return (ExcelsiorjsaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ExcelsiorjsaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ExcelsiorjsaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ExcelsiorjsaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ExcelsiorjsaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ExcelsiorjsaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
