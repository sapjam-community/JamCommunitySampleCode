...
import com.sap.social.addons.excelsior.model.ExcelsiorProductGridComponentModel;


/**
 *
 */
public class ExcelsiorProductGridComponentRenderer<C extends ExcelsiorProductGridComponentModel> extends
		ExcelsiorComponentBaseRender<C>
{
	private static final Logger LOG = Logger.getLogger(ExcelsiorProductGridComponentRenderer.class);
