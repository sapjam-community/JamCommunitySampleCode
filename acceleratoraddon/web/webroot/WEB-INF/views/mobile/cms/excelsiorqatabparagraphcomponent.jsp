...
<div data-role="collapsible" data-theme="e" data-content-theme="c" data-collapsed="true" data-icon="arrow-u" id="qa_expand">
	<h3 id="tab_qa"><spring:theme code="label.tab.qa"/></h3>
	<p id="tabBody_qas">
	<div id="ex-questions">
	</div>
