...
<div class="excelsior-detailpage">
    <div class="excelsior-spinner excelsior-loading" index="1"></div>
    <div class="excelsior-spinner excelsior-loading" index="2"></div>
</div>
<div id="ex-panel">
    <div id="ex-panel-review"></div>
    <div id="ex-panel-question"></div>
    <div class="ex-clear"></div>
</div>
<div>
