...
<div class="scroller" >
    ...
    <div class="excelsior-homepage">
        <div class="excelsior-spinner excelsior-loading col-sm-12 col-md-6"></div>
        <div class="excelsior-spinner excelsior-loading col-sm-12 col-md-6"></div>
    </div>
    ...
    <div id="homepage-widget-addon">
        <div id="homepage-widget-addon-question" class="col-sm-12 col-md-6"></div>
        <div id="homepage-widget-addon-review" class="col-sm-12 col-md-6"></div>
    </div>
